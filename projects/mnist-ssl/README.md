...
The completed neural impurity-tree investigation is retained as results only;
its experimental code and checkpoints were removed after the approach reached
diminishing returns. See the
[experiment log](docs/experiment-log.md)
and [final result record](results/reproductions/2026-07-22-neural-impurity-tree-final.json).
