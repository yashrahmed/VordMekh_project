...
Loads a classifier checkpoint written by :mod:`mnist_ssl.ijepa.train_probe`,
...
touches the test set.
    ...
    python scripts/evaluate/ijepa_probe.py \
...
from .train_probe import DEFAULT_POOL, ENCODERS, N_CLASSES, TwoLayerMLP
