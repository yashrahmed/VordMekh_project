...
encoder weights + config) that :mod:`mnist_ssl.ijepa.eval_probe` scores on the
held-out test set.
...
final checkpoint is written.
    ...
    python scripts/train/ijepa_probe.py
    python scripts/train/ijepa_probe.py --unfreeze --epochs 50
...
from . import cnn_stem_ijepa, custom_ijepa
from mnist_ssl.baselines.eval_classifier import mnist_loader
