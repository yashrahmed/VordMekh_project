...
from mnist_ssl.ijepa.train_probe import N_CLASSES, TwoLayerMLP, extract_features

from .eval_classifier import error_features
...
def run(args: argparse.Namespace) -> list[dict]:
    ...
    from .eval_classifier import extract_features as extract_split_features
