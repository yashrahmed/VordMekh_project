...
1.  In `projects/chai-gpt`, create a file named `keys-config.yml`.
...
To run ChaiGPT V2, execute the following command from the repository root:

```bash
cd projects/chai-gpt
