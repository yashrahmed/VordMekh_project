...
RECIPE_EXPLORATION_DIR = PROJECT_ROOT / 'chai_gpt_v7' / 'recipe-exploration'
SRC = RECIPE_EXPLORATION_DIR / 'recipe-responses.txt'
OUT = RECIPE_EXPLORATION_DIR / 'missing-actions.txt'
